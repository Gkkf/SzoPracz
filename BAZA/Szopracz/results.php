    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <div id="content_area">
                ...
                <div id="products_box">
                <?php
                    //zapytanie wykonujące pozostałą część kodu po otrzymaniu informacji o szukaniu zawartości
                    if(isset($_GET['button_search']))
                    {
                        //lokalna zmienna do przekazywania danych z $_GET
                        $search_query = $_GET['search'];

                            global $con;

                            //pobieranie wyszukanych produktów i wyświetlanie na stronie głównej z bazy danych
                            $get_pro = "SELECT * FROM produkty WHERE produkt_skluczowe LIKE '%$search_query%'";
