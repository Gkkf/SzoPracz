<!--Kopia index.php zamieniona na wyświetlania dokładnych informacji o danym produkcie, który wybrał użytkownik-->
            ...
            <div id="content_area">
                ...
                <!--Koniec obszaru paska koszyka-->
                    <?php
                        ...
                        {
                            //lokalna zmienna do pobierania danych z funkcji $_GET
                            $product_id = $_GET['pro_id'];

                            //pobieranie klikniętego przedmiotu z bazy danych poprzez zapytanie używające odpowiedniego ID przedmiotu
                            $get_pro = "SELECT * FROM produkty WHERE produkt_id = '$product_id'";
                            ...
                            while($row_pro = mysqli_fetch_array($run_pro))
                            {
                                ...
                                $pro_amount = $row_pro['produkt_ilosc'];
                                ...
                                echo "
                                    <div id='single_product' style='float: left; margin-left: 20px; padding: 10px; text-align: center;'>
                                        ...
                                        <p style='font-size: 35px; font-weight: bold; font-family: Arial, Helvetica, sans-serif; float: right; padding-left: 150px; padding-top: 100px;'>$pro_title</p>

                                        <img src='Admin/product_images/$pro_image' style='border: 2px solid black;' width='400px' height='300px'></img>

                                        <p style='font-family: Arial, Helvetica, sans-serif; padding-top: 20px; padding-bottom: 5px; text-align: left;'><b style='font-weight: bold;'>Cena:</b> $pro_price zł</p>

                                        <p style='font-family: Arial, Helvetica, sans-serif; padding-top: 5px; padding-bottom: 5px; text-align: left;'><b style='font-weight: bold;'>Dostępna ilość:</b> $pro_amount</p>
                                        
                                        <p style='font-family: Arial, Helvetica, sans-serif; padding-top: 5px; padding-bottom: 5px; text-align: left;'><b style='font-weight: bold;'>Rozmiar:</b> <b style='text-transform: uppercase;'>$pro_size</b></p>
                                        
                                        <p style='font-family: Arial, Helvetica, sans-serif; padding-top: 15px; padding-bottom: 5px; text-align: left;'>$pro_desc</p>
                                    </div>
                                    <div style='float: left; margin-left: 20px; padding: 10px;'>
                                        <a href='index.php'><button style='float: left; width: 200px; height: 55px; margin-top: 230px;'>Powrót</button></a>
                                ";
                                if($pro_qty>0)
                                {
                                    echo 
                                    "
                                            <a href='index.php?add_cart=$pro_id'><button style='float: right; width: 200px; height: 55px; margin-left: 335px; margin-top: 230px;'>Dodaj do koszyka</button></a>
                                        </div>
                                    ";
                                }   
                                else
                                {
                                    echo 
                                    "
                                            <a href=''><button style='float: right; width: 200px; height: 55px; margin-left: 335px; margin-top: 230px;' disabled>Braki w magazynie</button></a>
                                        </div>
                                    ";
                                }                             
                            }
